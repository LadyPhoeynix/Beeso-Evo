...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " beeso-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  beeso-tx [options] <hex-tx> [commands]  Update hex-encoded transaction\n" +
            "or:     beeso-tx [options] -create [commands]   Create hex-encoded transaction\n" +
            "\n";

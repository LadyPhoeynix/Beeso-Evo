...
const char * const BITCOIN_CONF_FILENAME = "beeso.conf";
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Beeso
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Beeso
    // Mac: ~/Library/Application Support/Beeso
    // Unix: ~/.beeso
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Beeso";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Beeso";
#else
    // Unix
    return pathRet / ".beeso";
#endif
#endif
}

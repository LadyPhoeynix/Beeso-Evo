...
/**
 * Build genesis block for testnet.  In Beeso, it has a changed timestamp
...
public:
    CMainParams() {
        ...
        /* Beeso activates CSV/Segwit with BIP16.  */
        ...
        // The value is the chain work of the Beeso mainnet chain at height
        ...
        /* See also doc/BeesoBugs.txt for more explanation on the
           historical bugs added below.  */

        /* These transactions have name outputs but a non-Beeso tx version.
           They contain NAME_NEWs, which are fine, and also NAME_FIRSTUPDATE.
           The latter are not interpreted by beesod, thus also ignore
           them for us here.  */
        ...
        /* These are non-Beeso tx that contain just NAME_NEWs.  Those were
           ...
           "ignore" them, as their outputs need no special Beeso handling
...
public:
    CTestNetParams() {
        ...
        // The best chain should have at least this much work.
        // The value is the chain work of the Beeso testnet chain at height
        ...
        vSeeds.emplace_back("dnsseed.test.beeso.webbtc.com");
